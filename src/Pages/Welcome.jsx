...
const Welcome = () => {
  const { navigate, setIdToken, idToken, emailVerified, setEmailVerified } = useContext(ContextFile)
  const handleClick = () => {
    navigate("/contact")
  };
  ...
  const handleVerify = () => {
    ...
    axios.post(
      ...
      console.log(err)
      if(err?.message=='The provided ID token is not a valid Firebase ID token.'){
  ...
  return (
    <div>
      ...
      <div className="mt-10 flex justify-center gap-10">
        ...
        <button className="bg-blue-600 px-4 py-2 text-white" onClick={handleVerify}>
          Verify Email
        </button>
